...
url(r'^quizze/(?P<id>\d+)$', views.quizze, name='quizze'),
...
url(r'^ajouterVideoToChapitre$', views.ajouterVideoToChapitre, name='ajouterVideoToChapitre'),
url(r'^ajouterFichier$', views.ajouterFichier, name='ajouterFichier'),
url(r'^ajouterQuizzeToChapitre$', views.ajouterQuizzeToChapitre, name='ajouterQuizzeToChapitre'),
...
url(r'^deleteFile/(?P<idCours>\d+)/(?P<idChapitre>\d+)/(?P<idFile>\d+)$', views.deleteFile, name='deleteFile'),
